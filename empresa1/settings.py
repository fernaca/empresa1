"""
Django settings for empresa1 project.
...
SECRET_KEY = 'django-insecure-rb!0kf(-%8t5zub%^bqsgnk&0&1h0^s+ad33i6qo4el^6is58i'
...
WSGI_APPLICATION = 'empresa1.wsgi.application'
